...
function decode_scanNumber(s,startPos)
  ...
  --local stringEval = load( "print( stringValue )" )( ) --loadstring(stringValue)
  local stringEval = load(stringValue) --loadstring(stringValue) in lua5.3 load instead loadstring
